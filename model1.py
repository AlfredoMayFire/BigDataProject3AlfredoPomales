...
data = pd.read_csv("/usr/local/code/cleantextlabels7.csv")
testData = pd.read_csv("/usr/local/code/fullTweets.csv", dtype=object, error_bad_lines=False)
...
df.to_csv("predictionsModel1.csv")
